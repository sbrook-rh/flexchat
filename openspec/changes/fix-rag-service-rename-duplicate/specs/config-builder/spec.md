...
The system SHALL provide a complete UI for adding, editing, and removing AI and RAG providers with separate workflows for LLM and RAG providers, using stable IDs separate from display names for RAG services.
